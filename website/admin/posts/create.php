  ...
  <?php include "../../app/include/sidebar-admin.php"; ?>
      ...
      <div class="button row">
        ...
        <div class="row title-table">
          ...
          <input value="<?=$title; ?>" name="title" type="text" class="form-control" placeholder="Заголовок" aria-label="Заголовок статті">
    ...
    <div class="form-check">
        <input class="form-check-input" name="publish" type="checkbox" value="1" id="flexCheckChecked" checked>
        <label class="form-check-label" for="flexCheckChecked"> Опублікувати</label>
    </div>
    <button name="add_post" class="btn btn-primary" type="submit">Додати</button>
</form>
        </div>
      </div>
    </div>
